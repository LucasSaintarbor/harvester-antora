...
You can create one or more StorageClasses from the menu:Advanced[StorageClasses] page.

image::/img/v1.2/storageclass/create_storageclasses_entry.png[]
...
image::/img/v1.2/storageclass/create_storageclasses_header_sections.png[]
...
image::/img/v1.2/storageclass/create_storageclasses_replicas.png[]
...
image::/img/v1.2/storageclass/create_storageclasses_stale_timeout.png[]

==== Node Selector (Optional)

Select the node tags to be matched in the volume scheduling stage. You can add node tags by going to menu:Host[Edit Config].

image::/img/v1.2/storageclass/create_storageclasses_node_selector.png[]

==== Disk Selector (Optional)

Select the disk tags to be matched in the volume scheduling stage. You can add disk tags by going to menu:Host[Edit Config].

image::/img/v1.2/storageclass/create_storageclasses_disk_selector.png[]

==== Migratable

Whether xref:../vm/live-migration.adoc[Live Migration] is supported. Defaults to `Yes`.

image::/img/v1.2/storageclass/create_storageclasses_migratable.png[]
...
image::/img/v1.2/storageclass/customize_tab_reclaim_policy.png[]
...
image::/img/v1.2/storageclass/customize_tab_allow_vol_expansion.png[]
...
image::/img/v1.2/storageclass/customize_tab_vol_binding_mode.png[]

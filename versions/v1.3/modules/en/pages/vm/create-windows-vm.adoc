...
:keywords: ["Harvester", "harvester", "Rancher", "rancher", "Windows", "windows", "Virtual Machine", "virtual machine", "Create a Windows VM"]
...
image::/img/v1.2/vm/create-windows-vm.png[create-windows-vm]
...
image::/img/v1.2/vm/create-windows-vm-volumes.png[create-windows-vm-volumes]
...
image::/img/v1.2/vm/create-windows-vm-networks.png[create-windows-vm-networks]
...
image::/img/v1.2/vm/create-windows-vm-scheduling.png[create-windows-vm-scheduling]
...
image::/img/v1.2/vm/create-windows-vm-advanced.png[create-windows-vm-advanced]
...
. (Optional) If you are using `virtio` based volumes, you will need to load the specific driver to allow the installer to detect them. If you're using VM template `windows-iso-image-base-template`, the instruction is as follows:
 ...
 image:/img/v1.2/vm/find-virtio-driver-directory.png[find-virtio-driver-directory]
 ...
 image:/img/v1.2/vm/select-virtio-block-driver.png[select-virtio-block-driver]
 ...
 image:/img/v1.2/vm/installer-found-virtio-drive.png[installer-found-virtio-drive]
...
image::/img/v1.2/vm/efi-shell.png[efi-shell]
...
image::/img/v1.2/vm/boot-from-cd.png[boot-from-cd]
...
image::/img/v1.2/vm/reserved-memory-config.png[reserved-memory-config]

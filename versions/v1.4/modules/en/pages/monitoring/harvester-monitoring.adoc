...
Users can also enable/disable the `rancher-monitoring` addon in their Harvester installation by customizing the link:../install/harvester-configuration.adoc#installaddons[harvester-configuration] file.
...
image::/img/v1.2/monitoring/monitoring-dashboard.png[]
...
image::/img/v1.2/monitoring/vm-metrics.png[]
...
image::/img/v1.2/monitoring/modify-prometheus-settings-from-addon.png[]
...
image::/img/v1.2/monitoring/modify-alertmanager-from-addon.png[]
...
image::/img/v1.2/monitoring/alertmanager-config-create-1.png[]

Click the `Alertmanager Configs` you just created to continue the configuration.

image::/img/v1.2/monitoring/view-alertmanager-config.png[]

Click `Add Receiver`.

image::/img/v1.2/monitoring/prepare-to-add-receiver.png[]

Set the `Name` for the receiver. After this, select the receiver type, for example, `Webhook`, and click `Add Webhook`.

image::/img/v1.2/monitoring/webhook-receiver-1.png[]

Fill in the required parameters and click `Create`.

image::/img/v1.2/monitoring/webhook-receiver-2.png[]
...
image::/img/v1.2/monitoring/alertmanager-dashboard.png[]

You can view the details of an alert:

image::/img/v1.2/monitoring/alert-view-detail.png[]
...
image::/img/v1.2/monitoring/prometheus-original-alerts.png[]

...
Once there is an upgradable version, the Harvester GUI Dashboard page will show an upgrade button. For more details, please refer to link:./automatic.adoc#start-an-upgrade[start an upgrade].

For the air-gap env upgrade, please refer to link:./automatic.adoc#prepare-an-air-gapped-upgrade[prepare an air-gapped upgrade].
...
image::/img/v1.2/upgrade/known_issues/3839-error.png[]
...
image::/img/v1.2/upgrade/known_issues/4246-pending.png[]

Please perform the following steps to check if the cluster runs into the issue:

. Check the upgrade repository pod:
+
image::/img/v1.2/upgrade/known_issues/4246-upgrade-repo-pod.png[]
+
...
. Check the upgrade repository volume in the Longhorn GUI.
 .. link:../troubleshooting/harvester.adoc#access-embedded-rancher-and-longhorn-dashboards[Go to Longhorn GUI].
...
+
image::/img/v1.2/upgrade/known_issues/4246-pending-replica.png[]
 ...
 ** link:./troubleshooting.adoc#start-over-an-upgrade[Start over the upgrade].
...
Visit link:../troubleshooting/harvester.adoc#access-embedded-rancher-and-longhorn-dashboards["Access Embedded Longhorn"] to see how to access the embedded Longhorn GUI.

You can also check the pre-drain job logs. Please refer to link:./troubleshooting.adoc#phase-4-upgrade-nodes[Phase 4: Upgrade nodes] in the troubleshooting guide.
...
image::/img/v1.2/upgrade/known_issues/2894-deadline.png[]
...
image::/img/v1.2/upgrade/known_issues/3730-stuck.png[]
...
. Adjust the volumes's replicas to more than one.
 ...
 image:/img/v1.2/upgrade/known_issues/4249-adjust-volume-replica.png[]
...
image::/img/v1.2/upgrade/known_issues/4484-apply-manifests-stuck.png[]
...
image::/img/v1.2/upgrade/known_issues/stuck-in-post-draining.png[]
...
+
image::/img/v1.2/upgrade/known_issues/4519-harvester-settings-ssl-certificates.png[]
...
When you link:../upgrade/automatic.adoc#start-an-upgrade[start an upgrade] and Harvester returns such an error message: `admission webhook "validator.harvesterhci.io" denied the request: managed chart rancher-monitoring-crd is not ready, please wait for it to be ready`. Please follow this link:../troubleshooting/monitoring.adoc#the-state-of-the-rancher-monitoring-crd-managedchart-is-modified[troubleshooting].

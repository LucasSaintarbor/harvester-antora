...
:experimental:
:keywords: ["Harvester", "harvester", "Rancher Integration"]
...
+
image::/img/v1.2/rancher/install-harvester-csi-driver.png[]
...
image::/img/v1.2/rancher/rke2-cloud-provider.png[select-harvester-cloud-provider]
...
----
+
image::/img/v1.1/rancher/creating_guest_cluster.png[]
+
...
+
image::/img/v1.2/rancher/non-harvester-cloud-provider.png[]
...
+
image::/img/v1.2/rancher/install_csi_rancher_marketplace.png[]
+
image::/img/v1.2/rancher/donot_change_cloud_config_path.png[]
...
You can follow the link:./csi-driver.adoc#deploy-harvester-csi-driver[Deploy Harvester CSI Driver] steps described in the RKE2 section.
...
+
Example:
 image:/img/v1.3/rancher/create-new-sc.png[]

. Deploy the CSI driver with the parameter `host-storage-class`.
+
Example:
 image:/img/v1.3/rancher/deploy-csi-driver-with-host-storage-class.png[]
...
image::/img/v1.2/rancher/error_event_csi_driver.png[]
...
. For administrators, you can create a desired xref:../advanced/storageclass.adoc[StorageClass] (e.g., named *replica-2*) in your bare-metal Harvester cluster.
+
image::/img/v1.2/rancher/sc-replica-2.png[]
...
+
image::/img/v1.2/rancher/downstream-cluster-sc-creation.png[]
+

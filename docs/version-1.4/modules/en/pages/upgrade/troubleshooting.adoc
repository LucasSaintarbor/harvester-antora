...
* Check link:./automatic.adoc#upgrade-support-matrix[version-specific upgrade notes]. You can click the version in the support matrix table to see if there are any known issues.
...
The Harvester upgrade process includes several phases.
    image:/img/v1.2/upgrade/ts_upgrade_phases.png[]
...
image::/img/v1.2/upgrade/ts_status_phase1.png[]
...
image::/img/v1.2/upgrade/ts_status_phase2.png[]
...
image::/img/v1.2/upgrade/ts_status_phase3.png[]
...
image::/img/v1.2/upgrade/ts_status_phase4.png[]
...
image::/img/v1.2/upgrade/enable_logging.png[The "Enable Logging" checkbox on the upgrade confirmation dialog]

You can click the *Download Log* button to download the log archive during an upgrade.

image::/img/v1.2/upgrade/download_upgradelog_dialog.png[Download the upgrade log archive by clicking the "Download Log" button on the upgrade dialog]
...
image::/img/v1.2/upgrade/upgradelog_archive.png[The upgrade log archive contains all the logs generated by the upgrade-related Pods]
...
image::/img/v1.2/upgrade/dismiss_upgrade_to_remove_upgradelog.png[The upgrade log archive contains all the logs generated by the upgrade-related Pods]
...
image::/img/v1.4/upgrade/disk-space-not-enough-error-message.png[Disk space not enough error message]

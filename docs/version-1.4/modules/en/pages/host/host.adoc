...
image::/img/v1.2/host/host.png[host.png]
...
image::/img/v1.2/host/node-maintenance.png[node-maintenance.png]
...
image::/img/v1.2/host/cordon-nodes.png[cordon-node.png]
...
+
When you remove a control plane node, a worker node will be promoted to control plane node. Harvester v1.3.0 allows you to assign a role to each node that joins a cluster. In earlier Harvester versions, worker nodes were randomly selected for promotion. If you prefer to promote specific nodes, please see link:./host.adoc#role-management[Role Management] and link:../install/harvester-configuration.adoc#installrole[Harvester Configuration] for more information.
...
. Access the link:../troubleshooting/harvester.adoc#access-embedded-rancher-and-longhorn-dashboards[embedded Longhorn UI].
...
xref:../vm/live-migration.adoc[Live migration] cannot be performed for VMs with certain properties.
...
If your cluster is running Harvester v1.1.2 or later, you can enable link:./host.adoc#node-maintenance[Maintenance Mode] on the node to automatically live-migrate VMs and workloads. You can also link:/vm/live-migration.adoc#starting-a-migration[manually live-migrate] VMs to other nodes.

All workloads have been successfully evicted if the node state is *Maintenance*.

image::/img/v1.3/host/node-maintain-completed.png[node-maintain-completed.png]
...
image::/img/v1.2/host/delete-node.png[delete.png]
...
For more information about assigning roles to nodes, see link:/v1.3/install/index[ISO Installation].
...
image::/img/v1.2/host/edit-config.png[Edit Config]

. Select the *Storage* tab and click *Add Disk*.

image::/img/v1.2/host/add-disks.png[Add Disks]
...
image::/img/v1.2/host/force-format-disks.png[Force Format]
...
image::/img/v1.2/host/check-added-disks.png[Check Result]
...
. On the xref:../advanced/storageclass.adoc[StorageClasses] page, create a new storage class and select those defined tags on the `Node Selector` and `Disk Selector` fields.
...
image::/img/v1.2/host/remove-disks-harvester-find-disk.png[Find disk to remove]

==== Evict replicas (Longhorn dashboard)

. Please follow link:../troubleshooting/harvester.adoc#access-embedded-rancher-and-longhorn-dashboards[this session] to enable the embedded Longhorn dashboard.
...
image::/img/v1.2/host/remove-disks-longhorn-nodes.png[Check the removing disk]

. Select *Edit node and disks*.

image::/img/v1.2/host/remove-disks-longhorn-nodes-edit.png[Edit node and disks]
...
image::/img/v1.2/host/remove-disks-longhorn-nodes-evict-disk.png[Evict disk]

. The disk will be disabled. Please wait until the disk replica count becomes `0` to proceed with removing the disk.

image::/img/v1.2/host/remove-disks-longhorn-wait-replicas.png[Wait replicas]
...
image::/img/v1.2/host/remove-disks-harvester-remove.png[Remove disk]
...
image::/img/v1.2/host/edit-ksmtuned.png[Edit Ksmtuned]

. Click *Save* to update.
. Wait for about 1-2 minutes and you can check its *Statistics* by clicking menu:Your Node[Ksmtuned tab].

image::/img/v1.2/host/view-ksmtuned-statistics.png[View Ksmtuned Statistics]
...
image::/img/v1.3/host/harvester-ntp-settings.png[]

You can set up multiple NTP servers at once.

image::/img/v1.3/host/harvester-ntp-settings-multiple.png[]
...
image::/img/v1.3/host/harvester-ntp-settings-empty.png[]

== Cloud-Native Node Configuration

You may need to customize one or more nodes after installing Harvester. This process usually entails updating the link:/v1.3/install/update-harvester-configuration/[runtime configuration] and modifying files in the `/oem` directory of each node to make changes persist after rebooting.

...
image::/img/v1.2/volume/expand-volume.png[expand-volume]
...
image::/img/v1.2/volume/cancel-failed-volume-expansion.png[cancel-failed-volume-expansion]
...
. link:./volume-snapshots.adoc#create-volume-snapshots[Take a volume snapshot].
. Select StorageClass when link:./volume-snapshots.adoc#restore-a-new-volume-from-a-volume-snapshot[restoring the volume using snapshot].

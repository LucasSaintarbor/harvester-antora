...
* Change the link:../install/harvester-configuration/#installharvesterstorage_classreplica_count[replica count] of `harvester-longhorn` to *1* using a xref:../install/harvester-configuration.adoc[Harvester configuration] file.

...
image::/img/v1.2/rancher/rke1-node-driver.png[rke1-cluster]
...
* For port requirements of guest clusters deployed within Harvester, please refer to the link:../../install/requirements.adoc#port-requirements-for-k3s-or-rkerke2-clusters[port requirements for guest clusters].
====
...
image::/img/v1.2/rancher/node-template.png[]
...
image:/img/v1.2/rancher/affinity-add-node-selector.png[affinity-add-node-selector]
...
----
+
image::/img/v1.2/rancher/affinity-add-rules.png[affinity-add-rules]
...
. On the *Cluster Options* configure `Cloud Provider` to `Harvester` if you want to use the Harvester xref:../cloud-provider.adoc[Cloud Provider] and xref:../csi-driver.adoc[CSI Diver].
image:/img/v1.2/rancher/enable-harvester-cloud-provider.png[]
. Click *Create*.

image::/img/v1.2/rancher/create-rke-harvester-cluster.png[create-rke-harvester-cluster]
